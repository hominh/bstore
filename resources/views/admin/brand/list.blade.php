		...
		<div class="col-md-12">
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-globe"></i>Brands
					</div>
					<div class="tools">
						<div class="dt-buttons">
						<a class="dt-button buttons-print btn default" tabindex="0" aria-controls="sample_2" href="#"><span>Add brand</span></a>
            	...
            	<tbody>
            		...
            		<tr>
									...
									<td> {!! $item->uname !!} </td>
									<td> <a href="{{ URL::route('admin.brand.edit',$item->id) }}">Edit</a> </td>
									<td> <a onclick="return confirmDelete('Are you sure Delete?')" href="{{ URL::route('admin.brand.delete',$item->id) }}"> Delete</a> </td>
              	</tr>
              	@endforeach()
              </tbody>
					</table>
