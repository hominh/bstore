			...
			<div class="portlet box green">
				<div class="portlet-title">
					...
					<div class="tools">
						...
						<a class="dt-button buttons-print btn default" tabindex="0" aria-controls="sample_2" href="#"><span>Add service</span></a>
            	...
            	<tbody>
            		...
            		<tr>
									...
									<td> {!! $item->uname !!} </td>
									<td> <a href="{{ URL::route('admin.service.edit',$item->id) }}">Edit</a> </td>
									<td> <a onclick="return confirmDelete('Are you sure Delete?')" href="{{ URL::route('admin.service.delete',$item->id) }}"> Delete</a> </td>
              	</tr>
              	@endforeach()
              </tbody>
					</table>
